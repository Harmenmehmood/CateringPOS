...
<div class="container-flex pt-3 " style="background-color:#b5192e;">
    ...
    <div class="row no-gutters pl-5 pr-5 bg-dark">
        ...
        <div class="row bg-dark text-center justify-content-center align-item-center bg-dark col-12 ml-1">
            <input type="text" class="col-3 bg-dark text-white  mt-2 mr-1 text-center form-control" id="discount" autocomplete="off" placeholder="Discount in Percentage" />
        </div>
        <div class="row bg-dark text-center justify-content-center align-item-center bg-dark col-12 ml-1">
            <input type="text" class="col-3 bg-dark text-white  mt-2 text-center  form-control" id="amount" autocomplete="off" placeholder="Amount Paid By Customer" />
        </div>
...
<!-- <button style='width:40%; margin-left: 30%;' class='btn btn-sm mt-3 btn-danger text-black button complete_bill_btn center'>Show Complete Bill</button><br><br> -->
<button style='width:40%; margin-left: 30%;' class='btn btn-sm mt-3 btn-danger text-black button print_btn center'>Print Bill</button><br><br>
...
<script>
    $(document).ready(function() {
        ...
        $('.print_btn').click(function() {
            ...
            if (type == 1) {
                if (table > 0) {
                    var amountPaid = parseInt($('#amount').val());
