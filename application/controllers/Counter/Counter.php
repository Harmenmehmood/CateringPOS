...
class Counter extends CI_Controller
{
	...
	public function update_table_order()
	{
		...
		<tr>
			...
			$gstPerentage = $this->Counter_Model->get_gst();
			$gstTax = $temp * $gstPerentage;



			// $current_bill .= '<tr ><td></td><td class="text-center" style="text-align:center"><b>Discount</b></td><td></td><td class="text-center" style="text-align:center"><b>Rs.' . $discount_amount . '</b>';
			// $current_bill .= '</td></tr>';
			$current_bill .= '<tr ><td colspan="3"  class="text-center" style="text-align:center"><b>Total</b></td><td class="text-center" style="text-align:center"><b>Rs.' . $discount_total . '</b>';
			$current_bill .= '</td></tr>';
			$current_bill .= '<tr ><td colspan="3" class="text-center" style="text-align:center"><b>GST Tax*</b></td><td class="text-center" style="text-align:center"><b>Rs.' . $gstTax . '</b>';
			$current_bill .= '</td></tr>';
			$current_bill .= '<tr ><td colspan="3" class="text-center" style="text-align:center"><b>Net Total</b></td><td class="text-center" style="text-align:center"><b>Rs.' . ($discount_total + $gstTax) . '</b>';
			$current_bill .= '</td></tr>';
	...
	public function updated_table_order()
	{
		...
		<tr>
			...
			$discount_total = $total - $discount_amount + $gstTax;
			...
			if ($amountPaid > 0) {
				...
				$current_bill .= '</td></tr>';
				$current_bill .= '<tr><td colspan="3" class="text-center" style="text-align:center"><b>Change</b></td><td class="text-center" style="text-align:center"><b>Rs.' . $remainAmount . '</b>';
				$current_bill .= '</td></tr>';
			}
